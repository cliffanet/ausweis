...
// ---- Common Options ----
var gMonths=["Янв","Фев","Мар","Апр","Май","Июн","Июл","Авг","Сен","Окт","Ноя","Дек"];
var gWeekDay=["в","п","в","с","ч","п","с"];	// weekday caption from Sunday to Saturday
...
var gsOutOfRange="Некорректно указан диапазон!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gsBottom=(NN4?"":"<DIV class='BottomDiv'>")+"<A class='BottomAnchor' href='javascript:void(0)' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Сегодня</A>"+(NN4?"":"</DIV>");	// the content of the bottom section.
...
var gsTodayTip="Сегодня";	// tooltip for today
